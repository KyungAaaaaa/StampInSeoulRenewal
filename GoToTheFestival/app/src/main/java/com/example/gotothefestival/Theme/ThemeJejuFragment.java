...
public class ThemeJejuFragment extends Fragment {
    ...
    public static ThemeJejuFragment newInstance() {
        ThemeJejuFragment themeJejuFragment = new ThemeJejuFragment();
        return themeJejuFragment;
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        list = new ArrayList<>();
        ThemeJejuFragment.AsyncTaskClassMain async = new ThemeJejuFragment.AsyncTaskClassMain();
        async.execute();
    ...
    class AsyncTaskClassMain extends android.os.AsyncTask<Integer, Long, String> {
        ...
        protected String doInBackground(Integer... integers) {
            list = themeActivity.requestData(39);
