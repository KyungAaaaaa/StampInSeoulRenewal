...
public class ThemeGangwonFragment extends Fragment {
    ...
    public static ThemeGangwonFragment newInstance() {
        ThemeGangwonFragment themeGangwonFragment = new ThemeGangwonFragment();
        return themeGangwonFragment;
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        list = new ArrayList<>();
        ThemeGangwonFragment.AsyncTaskClassMain async = new ThemeGangwonFragment.AsyncTaskClassMain();
        async.execute();
    ...
    class AsyncTaskClassMain extends android.os.AsyncTask<Integer, Long, String> {
        ...
        protected String doInBackground(Integer... integers) {
            list = themeActivity.requestData(32);
